...
document.getElementById("myButton").addEventListener("click", function () {
  window.location.href = "/public/login/index.html"; // 이 부분이 수정되었습니다.
});

// TODAY 버튼 클릭 시 today.html로 이동
document.getElementById("todayButton").addEventListener("click", function () {
  window.location.href = "/public/today/index.html"; // 이 부분이 수정되었습니다.
});

// KBO 버튼 클릭 시 kbo.html로 이동
document.getElementById("kboButton").addEventListener("click", function () {
  window.location.href = "/public/kbo/index.html"; // 이 부분이 수정되었습니다.
});
